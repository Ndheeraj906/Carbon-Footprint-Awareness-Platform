...
// Event bindings moved inline to prevent scope ReferenceErrors
...
function handleSocialLogin(provider) {
  showToast(`ℹ️ ${provider} login coming soon!`);
}
...
function bindEvents() {
  ...
  window.completeChallenge = _completeChallenge; // renamed via import
